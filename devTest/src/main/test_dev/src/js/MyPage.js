            ...
            if (res.data[0] == "false") {
                ...
                axios.get("/jobhunt/v1/Auth/refresh", {
                    ...
                    if (res.data[0] == "false"){
                      ...
                      window.location.href = "/jobhunt/v1/Users/mypage";
                    }
                })
            } 
...
const delete_bookmark= (e, companyname) => {
  if (ID != null) {
      Swal.fire({
          ...
          if (result.isConfirmed) { // 만약 모달창에서 confirm 버튼을 눌렀다면
            ...
            axios
            .post("/jobhunt/v1/Users/company-delete",
                {
                    companyname: companyname
  ...
  return (
      <div className="metee_mypage_main_wraper_join_style">
          <span className="myPageInfutTitle">이메일</span>
					<input className="myPageInputBox"  id='reg_mb_id' name="id" value={inputData[0].email} readonly /> 


          <span className="myPageInfutTitle">비밀번호</span>
					<input className="myPageInputBox" type="password"
						name="pass" maxlength="20" required
						placeholder="password-1"/>
				

          <span className="myPageInfutTitle">이름</span>
					<input className="myPageInputBox"  id='reg_mb_id' name="id" value={inputData[0].nickname} readonly /> 

          <span className="myPageInfutTitle">전화번호</span>
					<input className="myPageInputBox"  id='reg_mb_id' name="id" value={inputData[0].phone} readonly /> 

          <span className="myPageInfutTitle">내가 찜한 채용공고</span>
					<div className="Card1">
    ...
    return (
        <div className="container">
            <div className="card u-clearfix">
                ...
                <img src={del} className="delete-img" width="10px" onClick={(e) => { delete_bookmark(e,props.name) }}></img>
